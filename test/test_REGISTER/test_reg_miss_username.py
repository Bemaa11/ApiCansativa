...
def test():
    ...
    resp_user_name = req.json()["errors"]["user_name"][0]
    ...
    assert_that(resp_user_name).is_equal_to("The user name field is required.")
    # assert_that(resp_email).is_equal_to("The email has already been taken.")
